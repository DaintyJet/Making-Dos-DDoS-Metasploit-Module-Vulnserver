...
* [Writing Modules](#writing-modules)
    ...
    * [deregister_options](#deregisteroptions-refhttpsgithubcomrapid7metasploit-frameworkwikihow-to-use-datastore-options1ec0c3c29961af66ff2dc3421e7e749a06a07ee4textcore20option-types-all20core20datastore)
    * [Creating new Datastore objects](#creating-new-datastore-objects-refhttpsgithubcomrapid7metasploit-frameworkwikihow-to-use-datastore-options1ec0c3c29961af66ff2dc3421e7e749a06a07ee4textcore20option-types-all20core20datastore)
    * [Accessing Datastore Objects](#accessing-datastore-objects-refhttpsgithubcomrapid7metasploit-frameworkwikihow-to-use-datastore-options1ec0c3c29961af66ff2dc3421e7e749a06a07ee4text0aend-modifying-datastore20options20at)
...
The function when it is empty will look like the following. Notice that the argument will be an array, which will be a comma separated list of Datastore objects to set or create.
```ruby
register_options(
  [
   ...,
